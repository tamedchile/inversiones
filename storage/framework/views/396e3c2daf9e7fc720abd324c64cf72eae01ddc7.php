            ...
            <section>
                        ...
                        <div class="col-md-7" style="padding: 100px; padding-left: 30px;">
                          ...
                          <?php else: ?>
                            ...
                            <?php if($user->tareas($user->id) === 0): ?>
                             ...
                             <input type="text" class="form-control" id="fecha_limite" name="fecha_limite" value=" <?php echo e($fechaRespuesta->fecha); ?>" style="display: none">
                        ...
                        <div class="col-md-4" >
                          <div class="col-md-12" style="padding: 100px; padding-left: 30px;">
                            ...
                            <?php if($user->tareas($user->id) < 2): ?>
                              ...
                              <h4 class="default-title"> Capacidad preliminar: </h4> <p class="m-t-15"><?php echo e($monto->monto_preliminar); ?> </p>
                    ...
                    <div class="wizard">
                            ...
                            <?php if($user->tareas($user->id) === 1 ): ?>
                              ...
                              <li class="active">
                                  <a href="#tab_definir_proyecto" data-toggle="tab" aria-expanded="false">
                                    <img src="<?php echo e(asset('img/edificio.png')); ?>" alt="">
                      ...
                      <div class="tab-content box-items">
                          ...
                          <div class="tab-pane <?php if( $clientDetail->eess == 0 ): ?> active <?php endif; ?>" id="tab_domain_business_email">
                              <div class="item open" id="js_item_box_9">
                                  <div class="item-heading">
                          ...
                          <div class="tab-pane" id="tab_business_website">
                            ...
                            <div class="tab-pane <?php if($clientDetail->llamado == 1): ?> <?php if($user->tareas($user->id) === 1 ): ?> active <?php endif; ?> <?php endif; ?>" id="tab_definir_proyecto">
                              <div class="item open" id="js_item_box_9">
                                  <div class="item-heading">
...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <input type="text" class="form-control" id="idUsuario" name="idUsuario" value=" <?php echo e($user->id); ?>" style="display: none">
      <div class="modal-body">
        <p>Ya estamos a pocos pasos, tu asesor se pondra en contacto contigo, te llamará al siguente numero: <?php echo e($clientDetail->mobile); ?>, ¿Deseas agendar la llamada? </p>
...
<?php $__env->startPush('footer-script'); ?>
    ...
    <script>
      ...
      function definirProyecto(){
        ...
        window.location.href = "<?php echo e(route('client.misPropiedades', 1)); ?>";
...
<?php echo $__env->make('layouts.client-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\inversiones\resources\views/client/tasks/edit.blade.php ENDPATH**/ ?>