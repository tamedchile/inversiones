<?php $__env->startSection('page-title'); ?>
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12 text-right">
            ...
            <label class="label <?php echo e($btnTextColor); ?>"><?php echo e($statusText); ?></label>

            <ol class="breadcrumb">
                <li><a href="<?php echo e(route('client.dashboard.index')); ?>"><?php echo app('translator')->get('app.menu.home'); ?></a></li>
                <li><a href="<?php echo e(route('client.projects.index')); ?>"><?php echo e($pageTitle); ?></a></li>
                <li class="active"><?php echo app('translator')->get('app.project'); ?></li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        <nav>
                            <ul>
                                <li class="tab-current"><a href="<?php echo e(route('client.projects.show', $project->id)); ?>"><span><?php echo app('translator')->get('modules.projects.overview'); ?></span></a></li>
                                ...
                                <li><a href="<?php echo e(route('client.project-invoice.show', $project->id)); ?>"><span><?php echo app('translator')->get('app.menu.invoices'); ?></span></a></li>
                                <?php endif; ?>
                            </ul>
                        </nav>
                    </div>
...
<?php echo $__env->make('layouts.client-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/client/projects/show.blade.php ENDPATH**/ ?>