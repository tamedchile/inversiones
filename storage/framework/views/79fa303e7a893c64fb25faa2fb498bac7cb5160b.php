...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="white-box">
                <h3 class="box-title m-b-0"><?php echo app('translator')->get('modules.currencySettings.addNewCurrency'); ?></h3>
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            <label for="company_name"><?php echo app('translator')->get('modules.currencySettings.currencyName'); ?></label>
                        ...
                        <div class="form-group">
                            <label for="company_email"><?php echo app('translator')->get('modules.currencySettings.currencySymbol'); ?></label>
                            <input type="text" class="form-control" id="currency_symbol" name="currency_symbol">
                        </div>
                        <div class="form-group">
                            <label for="company_phone"><?php echo app('translator')->get('modules.currencySettings.currencyCode'); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/currencies/create.blade.php ENDPATH**/ ?>