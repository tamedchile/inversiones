<div class="modal-header">
    ...
    <h4 class="modal-title"><?php if(isset($noteDetail->id)): ?> <?php echo app('translator')->get('app.edit'); ?> <?php else: ?> <?php echo app('translator')->get('app.addNew'); ?> <?php endif; ?> <?php echo app('translator')->get('app.menu.stickyNotes'); ?></h4>
</div>
...
</div><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/member/sticky-note/create-edit.blade.php ENDPATH**/ ?>