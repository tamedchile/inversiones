<h4><?php echo app('translator')->get('app.menu.tasks'); ?> <?php echo app('translator')->get('app.from'); ?> <?php echo e(\Carbon\Carbon::parse($startDate)->format($global->date_format)); ?> <i class="ti-arrow-right"></i> <?php echo e(\Carbon\Carbon::parse($endDate)->format($global->date_format)); ?></h4>
                        ...
                        <div class="panel panel-default lobipanel view-task" data-task-id="<?php echo e($task->id); ?>" data-sortable="true">
                            <div class="panel-body">
                                <div class="p-10 p-b-0 font-12 font-semi-bold"><?php echo e(ucfirst($task->heading)); ?>
                                    ...
                                    <span class="m-l-5 pull-right text-info font-semi-bold">#<?php echo e($task->id); ?></span>
                                ...
                                <div class="bg-grey p-10">
                                    ...
                                    <?php if($task->due_date->lt($today)): ?>
                                        <span class="text-danger"><i class="icon-calender"></i> <?php echo e($task->due_date->format($global->date_format)); ?></span>
                                    <?php elseif($task->due_date->eq($today)): ?>
                                        <span class="text-success"><i class="icon-calender"></i> <?php echo app('translator')->get('app.today'); ?></span>
                                    <?php else: ?>
...
//                console.log(el, $(el).index());
            ...
            $.easyAjax({
                url: '<?php echo e(route("member.taskboard.updateIndex")); ?>',
                type: 'POST',
                async: false,
        ...
        $('.add-task').click(function () {
            ...
            var url = '<?php echo e(route('member.all-tasks.ajaxCreate', ':id')); ?>';
            url = url.replace(':id', id);
        ...
        $('.delete-column').click(function () {
            var id = $(this).data('column-id');
            var url = '<?php echo e(route('member.taskboard.destroy', ':id')); ?>';
            url = url.replace(':id', id);
        ...
        $('.edit-column').click(function () {
            var id = $(this).data('column-id');
            var url = '<?php echo e(route("member.taskboard.edit", ':id')); ?>';
            url = url.replace(':id', id);
...
<?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/member/taskboard/board_data.blade.php ENDPATH**/ ?>