                                    ...
                                    <label class="control-label">Choose Payment Method
                                        <a href="javascript:;"
                                           ...
                                           class="btn btn-sm btn-outline btn-success">
                                            <i class="fa fa-plus"></i> <?php echo app('translator')->get('modules.offlinePayment.method'); ?>
                                        </a>
                                    </label>
                                    <select id="multiselect" name="payment_method" class="selectpicker form-control type">
                                        <?php $__currentLoopData = $offlinePaymentMethod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    function offlinePaymentMethod() {
        var url = '<?php echo e(route('super-admin.offline-payment-method.create')); ?>';
...
<?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/super-admin/companies/editPackage.blade.php ENDPATH**/ ?>