                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label"><?php echo app('translator')->get('modules.projects.startDate'); ?></label>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label"><?php echo app('translator')->get('modules.tasks.taskCategory'); ?> <a href="javascript:;" class="btn btn-sm btn-outline btn-success createTaskCategory"><i
                                        ...
                                        <div class="row m-b-10">
                                            <div class="col-md-6">
                                                ...
                                                <a href="javascript:;" class="btn btn-info btn-outline btn-sm createTaskCategory">
                                                    <i class="fa fa-plus"></i>
                                                    <?php echo app('translator')->get('modules.taskCategory.addTaskCategory'); ?>
                                                </a>
                                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/projects/tasks/show.blade.php ENDPATH**/ ?>