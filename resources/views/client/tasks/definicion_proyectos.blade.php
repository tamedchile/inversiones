                      ...
                      <div class="item-desc">
                          ...
                          <div class="box pad__30" id="div1">
                            ...
                            <div style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); padding: 30px;">
                              <div class="cabezera" >
                                  <img src="{{asset('img/edificio.png')}}" alt="Información personal" style="padding: 0 0 12px;"><b style="font-size: 25px; font-weight: 100;" class="titulo-menu">Datos del proyecto</b>
                                  <hr>
                                  @if(count($proyectos) == 0)
                                  <div class="row">
                                    <span class="pull-right text-green" style="margin-left: 5px"> <img src="{{asset('img/plus.png')}}" alt="Correcto" width="20px"> </span>
                                  <a class="editar-datos" onclick="agregarMas()" id="agregarMas" style="float: right;">Agregar más </a>
                                  </div>
                                  <br>
                                  <div class="row">
                                    <span class="pull-right text-green" style="margin-left: 5px"> <img src="{{asset('img/diverso.png')}}" alt="Correcto" width="20px"> </span>
                                    ...
                                    <div class="row">  
                                      <div class="col-md-4">
                                          <div class="row-data flex center">
                                                <p class="datos-contacto"><b>Inmobiliaria {{ $i }} :</b>{{ $proyecto->inmobiliaria }}</p>
                                          </div>
                                          <div class="row-data flex center">
                                                <p class="datos-contacto"><b>Tipo propiedad {{ $i }} :</b> {{ $proyecto->tipo_propiedad }} </p>
                                          </div>
                                        <div class="row-data flex center">
                                              <p class="datos-contacto"><b>Piso preferencia {{ $i }} :</b> {{ $proyecto->piso_preferencia }} </p>
                                        </div>
                                      </div>
                                      <div class="col-md-4">
                                        <div class="row-data flex center">
                                              <p class="datos-contacto"><b>Orientacion {{ $i }} :</b> {{ $proyecto->orientacion }}</p>
                                        </div>
                                        <div class="row-data flex center">
                                              <p class="datos-contacto"><b>Cantidad de baños {{ $i }} :</b> {{ $proyecto->cantidad_baños }} </p>
                                        </div>
                                        <div class="row-data flex center">
                                              <p class="datos-contacto"><b>Cantidad dormitorios {{ $i }} :</b> {{ $proyecto->cantidad_dormitorios }}</p>
                                        </div>
                                      </div>
                                      <div class="col-md-4">
                                        <div class="row-data flex center">
                                              <p class="datos-contacto"><b>Metros cuadrados {{ $i }} :</b> {{ $proyecto->metros_cuadrados }} </p>
                                        </div>
                                        <div class="row-data flex center">
                                              <p class="datos-contacto"><b>Observaciones {{ $i }} :</b> {{ $proyecto->observaciones }} </p>
                                        </div>
                                      </div>
                                    </div>
