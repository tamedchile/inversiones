                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="project-table">
                        ...
                        <tr>
                            ...
                            <th><?php echo app('translator')->get('modules.projects.members'); ?></th>
...
<script>
    $(function() {
        var table = $('#project-table').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('client.projects.data'); ?>',
            deferRender: true,
            language: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.client-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/client/projects/index.blade.php ENDPATH**/ ?>