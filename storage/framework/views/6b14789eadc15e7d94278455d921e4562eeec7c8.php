        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="vtabs customvtab m-t-10">
                    <?php echo $__env->make('sections.module_setting_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="tab-content">
                        <div id="vhome3" class="tab-pane active">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="white-box">
                                        <h3 class="box-title m-b-0"><?php echo e(ucfirst($type)); ?> <?php echo app('translator')->get("modules.moduleSettings.moduleSetting"); ?></h3>

                                        <p class="text-muted m-b-10 font-13">
                                            <?php echo app('translator')->get("modules.moduleSettings.employeeSubTitle"); ?> <?php echo e(ucfirst($type)); ?> <?php echo app('translator')->get("modules.moduleSettings.section"); ?>
                                        </p>
                                            ...
                                            <div class="col-sm-12 col-xs-12 b-t p-t-20">
                                                ...
                                                <?php $__currentLoopData = $modulesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="form-group col-md-4">
                                                        <label class="control-label col-xs-6" ><?php echo app('translator')->get('modules.module.'.$setting->module_name); ?></label>
                                                        <div class="col-xs-6">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/module-settings/index.blade.php ENDPATH**/ ?>