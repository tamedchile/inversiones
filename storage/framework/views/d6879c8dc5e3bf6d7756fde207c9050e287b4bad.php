    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><?php echo app('translator')->get('modules.projectTemplate.members'); ?></li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        <nav>
                            <ul>
                                <li><a href="<?php echo e(route('admin.project-template.show', $project->id)); ?>"><span><?php echo app('translator')->get('modules.projectTemplate.overview'); ?></span></a>
                                </li>
                                <li class="tab-current"><a href="<?php echo e(route('admin.project-template-member.show', $project->id)); ?>"><span><?php echo app('translator')->get('modules.projectTemplate.members'); ?></span></a></li>
                    ...
                    <div class="content-wrap">
                        <section id="section-line-2" class="show">
                            <div class="row">
                                            ...
                                            <div class="panel-body">
                                                    <table class="table">
                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $project->members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <tr>
                                                                <td>
                                                                    <?php echo '<img src="'.$member->user->image_url.' "alt="user" class="img-circle" width="40" height="40">'; ?>
                                                                ...
                                                                <td><a href="javascript:;" data-member-id="<?php echo e($member->id); ?>" class="btn btn-sm btn-danger btn-rounded delete-members"><i class="fa fa-times"></i> <?php echo app('translator')->get('app.remove'); ?></a></td>
                                                            </tr>
                                ...
                                <div class="col-md-6">
                                    <div class="white-box">
                                        <h3><?php echo app('translator')->get('modules.projectTemplate.addMemberTitle'); ?></h3>
                                        ...
                                        <h3><?php echo app('translator')->get('app.add'); ?> <?php echo app('translator')->get('app.department'); ?></h3>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group" id="user_id">
                                                <select class="select2 m-b-10 select2-multiple " multiple="multiple"
                                                        data-placeholder="Choose <?php echo app('translator')->get('app.department'); ?>" name="group_id[]">
...
<script type="text/javascript">
    ...
    $('#save-members').click(function () {
        $.easyAjax({
            url: '<?php echo e(route('admin.project-template-member.store')); ?>',
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('#save-group').click(function () {
        $.easyAjax({
            url: '<?php echo e(route('admin.project-template-members.storeGroup')); ?>',
            container: '#saveGroup',
            type: "POST",
...
$('body').on('click', '.delete-members', function(){
    ...
    swal({
        ...
        if (isConfirm) {
            ...
            var url = "<?php echo e(route('admin.project-template-member.destroy',':id')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/project-template/project-member/create.blade.php ENDPATH**/ ?>