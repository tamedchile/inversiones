...
<script>
    ...
    $('#post-message').click(function () {
        $.easyAjax({
            url: '<?php echo e(route('member.user-chat.message-submit')); ?>',
...
</script><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/member/user-chat/create.blade.php ENDPATH**/ ?>