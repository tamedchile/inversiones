            ...
            <?php if($key % 2 == 0): ?>
                <div class="row gap-y align-items-center">
                    <div class="col-12  col-md-5 text-center">
                        <img <?php if($value->image): ?>src="<?php echo e(asset_url('front/feature/'.$value->image)); ?>" <?php else: ?> src="<?php echo e(asset('front/img-3.png')); ?>" <?php endif; ?> alt="..." class="shadow-4">
                    </div>
            ...
            <?php else: ?>
                <div class="row gap-y align-items-center">
                    ...
                    <div class="col-12 offset-md-1 col-md-5 text-center">
                        <img <?php if($value->image): ?>src="<?php echo e(asset_url('front/feature/'.$value->image)); ?>" <?php else: ?> src="<?php echo e(asset('front/img-4.png')); ?>" <?php endif; ?> alt="..." class="shadow-4">
                    </div>
                </div>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/front/section/feature.blade.php ENDPATH**/ ?>