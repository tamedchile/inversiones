                                ...
                                <div class="row" id="form-contacto" hidden>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="mobile" id="mobile" class="form-control" value="{{ $clientDetail->mobile }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" id="address" rows="5" value="{{ $clientDetail->address }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        el textp cerrar permite volver a la vista de revision de datos en cada apartado <br>
         la imagen <img src="{{asset('img/remove.png')}}" alt="faltan datos" width="20px"> indica que en alguno de los apartados aun faltan datos por diligenciar <br>
         la imagen <img src="{{asset('img/correct.png')}}" alt="faltan datos" width="20px"> indica que los datos han sido diligenciados en su totalidad, a partir de este momento se cerrara la tarea y podras avanzar en tu proceso.
      </div>
