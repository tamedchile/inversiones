    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(route('admin.currency.index')); ?>"><?php echo e(__($pageTitle)); ?></a></li>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="white-box">
                <h3 class="box-title m-b-0"><?php echo app('translator')->get("modules.currencySettings.updateTitle"); ?></h3>
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            <label for="currency_name"><?php echo app('translator')->get("modules.currencySettings.currencyName"); ?></label>
                        ...
                        <div class="form-group" >
                            <label for="currency_symbol"><?php echo app('translator')->get("modules.currencySettings.currencySymbol"); ?></label>
                            <input type="text" class="form-control" id="currency_symbol" name="currency_symbol" value="<?php echo e($currency->currency_symbol); ?>">
                        </div>
                        <div class="form-group">
                            <label for="currency_code"><?php echo app('translator')->get("modules.currencySettings.currencyCode"); ?></label>
                        ...
                        <div class="form-group regular-currency"  <?php if($currency->is_cryptocurrency == 'yes'): ?> style="display: none;" <?php endif; ?>>
                            <label for="exchange_rate"><?php echo app('translator')->get("modules.currencySettings.exchangeRate"); ?></label>
...
<script>
    $('#save-form').click(function () {
        $.easyAjax({
            url: '<?php echo e(route('admin.currency.update', $currency->id )); ?>',
    ...
    $('#fetch-exchange-rate').click(function () {
        ...
        var url = '<?php echo e(route('admin.currency.exchange-rate', '#cc' )); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/currencies/edit.blade.php ENDPATH**/ ?>