            ...
            <div class="row">
                ...
                <div class="col-12" id="form-box">
                    <div class="form-group mb-4">
                        <label for="company_name" style="text-transform: none;">Nombre</label>
                        <input type="text" name="pnombre" id="pnombre" placeholder="Tu nombre" class="form-control" required>
                    </div>
                    <div class="form-group mb-4">
                        <label for="company_name" style="text-transform: none;">Apellido</label>
                        <input type="text" name="papellido" id="papellido" placeholder="Tu apellido" class="form-control" required>
                    </div>
                    <div class="form-group mb-4">
                        <label for="email" style="text-transform: none;">Dirección de correo</label>
                        <input type="email" name="email" id="email" placeholder="Tu dirección de correo" class="form-control" required>
                    </div>
                    <div class="form-group mb-4">
                        <label for="company_name" style="text-transform: none;">Institución o Empresa</label>
                    ...
                    <div class="form-group mb-4">
                        <label for="password_confirmation" style="text-transform: none;"><?php echo e(__('app.confirmPassword')); ?></label>
...
<?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/saas/register.blade.php ENDPATH**/ ?>