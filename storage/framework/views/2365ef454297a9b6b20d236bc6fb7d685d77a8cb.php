<script type="text/javascript">
    ...
    $('#update-app').click(function () {
        ...
        var supportText = " Your support has been expired on <b><span id='support-date'><?php echo e(\Carbon\Carbon::parse($envatoUpdateCompanySetting->supported_until)->format('d M, Y')); ?></span></b>";
            swal({
            ...
            if (isConfirm) {
                // window.location.url = "<?php echo e(config('froiden_envato.envato_product_url')); ?>";
                window.open(
...
<?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/vendor/froiden-envato/update/update_script.blade.php ENDPATH**/ ?>