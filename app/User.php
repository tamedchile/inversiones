...
class User extends BaseModel implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract
{
    ...
    protected $fillable = [
        'name','pnombre','snombre','papellido','sapellido', 'email', 'password', 'mobile', 'login', 'status', 'image', 'gender', 'locale', 'onesignal_player_id'
    ];
    ...
    {
        $tareas = DB::table('tareas')->where('user_id', $id)->first();
    ...
    public static function projectos($id)
    {
