                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <a href="<?php echo e(route('admin.currency.create')); ?>" class="btn btn-outline btn-success btn-sm"><?php echo app('translator')->get('modules.currencySettings.addNewCurrency'); ?> <i class="fa fa-plus" aria-hidden="true"></i></a>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="alert alert-info"><i class="fa fa-info-circle"></i> <?php echo app('translator')->get('messages.exchangeRateNote'); ?></div>
                                            </div>
                                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/currencies/index.blade.php ENDPATH**/ ?>