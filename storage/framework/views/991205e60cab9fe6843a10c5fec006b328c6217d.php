<?php $__env->startSection('page-title'); ?>
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="<?php echo e($pageIcon); ?>"></i> <?php echo e($pageTitle); ?> #<?php echo e($project->id); ?> - <span class="font-bold"><?php echo e(ucwords($project->project_name)); ?></span></h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(route('admin.project-template.index')); ?>"><?php echo e($pageTitle); ?></a></li>
            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        ...
                        <nav>
                            <ul>
                                <li ><a href="<?php echo e(route('admin.project-template.show', $project->id)); ?>"><span><?php echo app('translator')->get('modules.projects.overview'); ?></span></a>
                                </li>
                                ...
                                <li class="tab-current"><a href="<?php echo e(route('admin.project-template-task.show', $project->id)); ?>"><span><?php echo app('translator')->get('app.menu.tasks'); ?></span></a></li>
                            </ul>
                        </nav>
                    </div>
                                    ...
                                    <div class="row m-b-10">
                                        <div class="col-md-12 hide" id="new-task-panel">
                                            <div class="panel panel-default">
                                                <div class="panel-heading "><i class="ti-plus"></i> <?php echo app('translator')->get('modules.tasks.newTask'); ?>
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <select class="selectpicker" name="user_id" id="user_id"
                                                                            ...
                                                                            <option value=""><?php echo app('translator')->get('modules.tasks.chooseAssignee'); ?></option>
...
<script type="text/javascript">
    ...
    $('#save-task').click(function () {
        $.easyAjax({
            url: '<?php echo e(route('admin.project-template-task.store')); ?>',
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "<?php echo e(route('admin.project-template-task.destroy',':id')); ?>";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    taskListPanel.on('click', '.edit-task', function () {
        var id = $(this).data('task-id');
        var url = "<?php echo e(route('admin.project-template-task.edit', ':id')); ?>";
        url = url.replace(':id', id);
    ...
    taskListPanel.on('click', '.show-task-detail', function () {
        var id = $(this).data('task-id');
        var url = "<?php echo e(route('admin.project-template-task.detail', ':id')); ?>";
        url = url.replace(':id', id);
...
//         taskListPanel.switchClass("col-md-12", "col-md-6", 1000, "easeInOutQuad");
    ...
    function showTable() {
        var url = '<?php echo route('admin.project-template-task.data', [':templateId']); ?>?_token=<?php echo e(csrf_token()); ?>';

        url = url.replace(':templateId', '<?php echo e($project->id); ?>');
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/project-template/tasks/show.blade.php ENDPATH**/ ?>