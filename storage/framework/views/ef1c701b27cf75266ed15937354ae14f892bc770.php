...
<?php $__env->startPush('footer-script'); ?>
    ...
    <script type="text/javascript">
        ...
        gantt.attachEvent("onAfterTaskDrag", function(id, mode, e){
            <?php if($user->can('edit_tasks')): ?>
                var task = gantt.getTask(id);
                var taskId = task.taskid;
                var token = '<?php echo e(csrf_token()); ?>';
                var url = '<?php echo e(route('member.projects.gantt-task-update', ':id')); ?>';
        ...
        <?php if($ganttProjectId == ''): ?>
            gantt.load('<?php echo e(route("member.projects.ganttData")); ?>');
        <?php else: ?>
            gantt.config.open_tree_initially = true;
            gantt.load('<?php echo e(route("member.projects.ganttData", $ganttProjectId)); ?>');
        <?php endif; ?>

        function addTask(id, parentId) {
            var url = '<?php echo e(route('member.projects.ajaxCreate', ':id')); ?>';
        ...
        function loadData() {
            var url = '<?php echo e(route("member.projects.ganttData")); ?>';

            <?php if($ganttProjectId != ''): ?>
                var url = '<?php echo e(route("member.projects.ganttData", $ganttProjectId)); ?>';
            <?php endif; ?>
...
<?php echo $__env->make('layouts.member-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/member/projects/gantt.blade.php ENDPATH**/ ?>