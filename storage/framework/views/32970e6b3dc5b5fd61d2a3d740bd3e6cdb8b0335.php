<?php $__env->startSection('content'); ?>
    ...
    <form class="form-horizontal form-material" id="loginform" action="<?php echo e(route('login')); ?>" method="POST">
        ...
        <?php if(Session::has('message1')): ?>
          <div class="alert alert-info"><?php echo e(Session::get('message1')); ?></div>
        <?php endif; ?>
        ...
        <div class="form-group m-b-0">
            <div class="col-sm-12 text-center">
                <p>¿Aún no tienes una cuenta? <a href="<?php echo e(route('front.signup.index')); ?>" class="text-primary m-l-5"><b>Registrarse</b></a></p>
            </div>
        </div>
        <div class="form-group m-b-0">
            <div class="col-sm-12 text-center">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/auth/login.blade.php ENDPATH**/ ?>