...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="white-box">
                <h3 class="box-title m-b-0"><?php echo app('translator')->get('app.add'); ?> <?php echo app('translator')->get('app.language'); ?></h3>
                    ...
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="form-group ">
                            ...
                            <select class="form-control" name="status">
                                <option value="enabled"><?php echo app('translator')->get('app.enable'); ?></option>
                                <option value="disabled"><?php echo app('translator')->get('app.disable'); ?></option>
                            </select>
                        </div>
...
<script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '<?php echo e(route('super-admin.language-settings.store')); ?>',
...
<?php echo $__env->make('layouts.super-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/super-admin/language-settings/create.blade.php ENDPATH**/ ?>