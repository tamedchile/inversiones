            ...
            <div class="user-bg">
                ...
                <div class="overlay-box">
                    <div class="user-content"> <a href="javascript:void(0)">
                            <img src="<?php echo e($employee->image_url); ?>" alt="user" class="thumb-lg img-circle">
                            </a>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="home">
                    <div class="steamline">
                        ...
                        <div class="sl-item">
                            <div class="sl-left">
                                <img src="<?php echo e($employee->image_url); ?>" alt="user" class="img-circle">'
                            </div>
                            <div class="sl-right">
                ...
                <div class="tab-pane" id="profile">
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-4"> <strong><?php echo app('translator')->get('app.mobile'); ?></strong> <br>
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-md-6 col-xs-6 b-r"> <strong><?php echo app('translator')->get('app.designation'); ?></strong> <br>
                        ...
                        <div class="col-md-6 col-xs-6"> <strong><?php echo app('translator')->get('app.department'); ?></strong> <br>
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-md-6 col-xs-6 b-r"> <strong><?php echo app('translator')->get('modules.employees.slackUsername'); ?></strong> <br>
                            <p class="text-muted"><?php echo e((!is_null($employee->employeeDetail)) ? '@'.$employee->employeeDetail->slack_username : 'NA'); ?></p>
                        </div>
                        <div class="col-md-6 col-xs-6"> <strong><?php echo app('translator')->get('modules.employees.joiningDate'); ?></strong> <br>
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-md-6 col-xs-6 b-r"> <strong><?php echo app('translator')->get('modules.employees.gender'); ?></strong> <br>
                            <p class="text-muted"><?php echo e($employee->gender); ?></p>
                        </div>
                        <div class="col-md-6 col-xs-6"> <strong><?php echo app('translator')->get('app.skills'); ?></strong> <br>
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-md-3 col-xs-6"> <strong><?php echo app('translator')->get('modules.employees.hourlyRate'); ?></strong> <br>
                ...
                <div class="tab-pane" id="projects">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="3"><?php echo app('translator')->get('messages.noProjectFound'); ?></td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
                        </table>
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            <table class="table" id="leave-table">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td><?php echo app('translator')->get('messages.noRecordFound'); ?></td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                <?php endif; ?>
                ...
                <div class="tab-pane" id="docs">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $employeeDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$employeeDoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a target="_blank" href="<?php echo e(asset_url('employee-docs/'.$employeeDoc->user_id.'/'.$employeeDoc->hashname)); ?>"
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="3"><?php echo app('translator')->get('messages.noDocsFound'); ?></td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/employees/show.blade.php ENDPATH**/ ?>