                ...
                <div class="panel-heading"> <?php echo app('translator')->get('modules.projects.createTitle'); ?>
                    <div class="pull-right">
                        <div class="btn-group m-r-10">
                            <button aria-expanded="true" data-toggle="dropdown" class="btn btn-block btn-info waves-effect dropdown-toggle waves-light" type="button"><?php echo app('translator')->get('app.menu.template'); ?> <span class="caret"></span></button>
                            <ul role="menu" class="dropdown-menu">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <li class="text-dark"><?php echo app('translator')->get('messages.noRecordFound'); ?></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <label class="control-label"><?php echo app('translator')->get('modules.projects.projectCategory'); ?> <a href="javascript:;"
                                                                                         id="addProjectCategory"
                                                                                         class="btn btn-sm btn-outline btn-success"><i
                                                        class="fa fa-plus"></i> <?php echo app('translator')->get('modules.projectCategory.addProjectCategory'); ?></a>
                                        </label>
                                ...
                                <div class="col-xs-12 col-md-3">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-info  col-md-10">
                                            ...
                                            <label for="default_project_member"><?php echo app('translator')->get('modules.projects.selfAssignAsProjectMember'); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/projects/create.blade.php ENDPATH**/ ?>