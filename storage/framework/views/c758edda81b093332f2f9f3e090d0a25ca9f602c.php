    ...
    $('body').on('click', '.sa-delete', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "<?php echo e(route('member.task-files.destroy',':id')); ?>";
...
<?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/member/all-tasks/ajax-file-list.blade.php ENDPATH**/ ?>