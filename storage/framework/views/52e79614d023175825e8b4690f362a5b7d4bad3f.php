                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="white-box">
                                        ...
                                        <h3><?php echo app('translator')->get('app.cta'); ?> <?php echo app('translator')->get('app.menu.settings'); ?></h3>
                                        <hr>
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12 col-xs-12">
                                                <div class="form-group">
                                                    <label for="title"><?php echo app('translator')->get('app.title'); ?></label>
                                                    <input type="text" class="form-control" id="title" name="title" value="<?php echo e($frontDetail->cta_title); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="detail" rows="5" name="detail"><?php echo e($frontDetail->cta_detail); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
...
<?php $__env->startPush('footer-script'); ?>
  <script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '<?php echo e(route('super-admin.cta-settings.update', $frontDetail->id)); ?>',
...
<?php echo $__env->make('layouts.super-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/super-admin/cta-settings/index.blade.php ENDPATH**/ ?>