...
#auth-form {
    ...
    <form class="form-horizontal form-material" id="loginform" action="{{ route('front.signup.store') }}" method="POST">
        {{ csrf_field() }}
        ...
        <div class="form-group m-b-0">
            <div class="col-sm-12 text-center">
                <p>¿Ya estás registrado? <a href="{{ route('login') }}" class="text-primary m-l-5"><b>Iniciar sesión</b></a></p>
            </div>
        </div>
    </form>
@endsection
