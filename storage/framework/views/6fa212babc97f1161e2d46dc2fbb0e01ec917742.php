<?php $__env->startSection('page-title'); ?>
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            ...
            <a href="javascript:;" id="add-column" class="btn btn-success btn-outline btn-sm"><i class="fa fa-plus"></i> <?php echo app('translator')->get('modules.tasks.addBoardColumn'); ?></a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/taskboard/index.blade.php ENDPATH**/ ?>