            ...
            <?php if(!$roles->isEmpty()): ?>
                <a href="javascript:;" id="addRole"
                    class="btn btn-success btn-sm btn-outline  waves-effect waves-light"><i
                         class="fa fa-gear"></i> <?php echo app('translator')->get("modules.roles.addRole"); ?></a>
            <?php endif; ?>
            <ol class="breadcrumb">
                        ...
                        <div class="col-md-12 b-all m-t-10">
                            <div class="row">
                                <div class="col-md-4 text-center p-10 bg-inverse ">
                                    <h5 class="text-white"><strong id="role_display_name"><?php echo e(ucwords($role->display_name)); ?></strong></h5>
                                </div>
                            ...
                            <div class="text-center">
                                <div class="empty-space" style="height: 200px;">
                                    <div class="empty-space-inner">
                                        ...
                                        <div class="title m-b-15"><?php echo app('translator')->get('messages.defaultRolesCantDelete'); ?>
                                        </div>
                                        <div class="subtitle">
                                            <a href="javascript:;" id="addRole"
                                               class="btn btn-success btn-sm btn-outline  waves-effect waves-light"><i
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/role-permission/index.blade.php ENDPATH**/ ?>