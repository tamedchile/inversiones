    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading"><?php echo app('translator')->get('app.update'); ?> <?php echo app('translator')->get('app.department'); ?></div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label for="company_name"><?php echo app('translator')->get('app.department'); ?></label>
                                    <input type="text" class="form-control" id="team_name" name="team_name" value="<?php echo e($group->team_name); ?>">
                                </div>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $group->member; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="row">
...
<?php $__env->startPush('footer-script'); ?>
    ...
    <script>
        ...
        $('#save-form').click(function () {
            $.easyAjax({
                url: '<?php echo e(route('admin.teams.update', [$group->id])); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/teams/edit.blade.php ENDPATH**/ ?>