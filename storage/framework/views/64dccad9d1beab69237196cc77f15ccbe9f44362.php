                            ...
                            <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control"
                                                        data-placeholder="<?php echo app('translator')->get("app.selectProject"); ?>" id="project_id"
                                                        name="project_id">
                                                    <option value=""></option>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label"><?php echo app('translator')->get('modules.tasks.taskCategory'); ?> <a
                                                        ...
                                                        class="btn btn-sm btn-outline btn-success"><i
                                                            class="fa fa-plus"></i> <?php echo app('translator')->get('modules.taskCategory.addTaskCategory'); ?>
                                                </a>
                                            </label>
                                ...
                                <div class="row" id="dependent-fields" style="display: none">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control"
                                                    data-placeholder="<?php echo app('translator')->get('modules.tasks.chooseTask'); ?>"
                                                ...
                                                <?php $__currentLoopData = $allTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allTask): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($allTask->id); ?>"><?php echo e($allTask->heading); ?>

                                                        (<?php echo app('translator')->get('app.dueDate'); ?>: <?php echo e($allTask->due_date->format($global->date_format)); ?>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox checkbox-info">
                                                <input id="private-task" name="is_private" value="true"
                                                       ...
                                                       type="checkbox">
                                                <label for="private-task"><?php echo app('translator')->get('modules.tasks.makePrivate'); ?> <a
                                                            class="mytooltip font-12" href="javascript:void(0)"> <i
                                                                class="fa fa-info-circle"></i><span
                                                                class="tooltip-content5"><span
                                                                    class="tooltip-text3"><span
                                                                        class="tooltip-inner2"><?php echo app('translator')->get('modules.tasks.privateInfo'); ?></span></span></span></a></label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-md-12" id="repeat-fields" style="display: none">
                                        ...
                                        <div class="col-xs-6 col-md-4">
                                            <div class="form-group">
                                                <label><?php echo app('translator')->get('modules.events.cycles'); ?> <a class="mytooltip"
                                                                                         href="javascript:void(0)"> <i
                                                                class="fa fa-info-circle"></i><span
                                                                class="tooltip-content5"><span
                                                                    class="tooltip-text3"><span
                                                                        class="tooltip-inner2"><?php echo app('translator')->get('modules.tasks.cyclesToolTip'); ?></span></span></span></a></label>
...
<?php $__env->startPush('footer-script'); ?>
    ...
    <script>
        ...
        $('#project_id').change(function () {
            ...
            var dependentTaskUrl = '<?php echo e(route('admin.all-tasks.dependent-tasks', ':id')); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/tasks/create.blade.php ENDPATH**/ ?>