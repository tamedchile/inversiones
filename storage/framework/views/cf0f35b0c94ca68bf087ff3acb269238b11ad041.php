                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="white-box">
                                        ...
                                        <h3><?php echo app('translator')->get('modules.frontCms.contactDetail'); ?></h3>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-xs-12">
                                                <div class="form-group">
                                                    <label for="phone"><?php echo app('translator')->get('modules.accountSettings.companyPhone'); ?></label>
...
<?php $__env->startPush('footer-script'); ?>
  <script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '<?php echo e(route('super-admin.contactus-setting-update')); ?>',
...
<?php echo $__env->make('layouts.super-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/super-admin/contact-settings/index.blade.php ENDPATH**/ ?>