...
<ul class="nav tabs-vertical">
    ...
    <li class="tab <?php if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.email-settings.index'): ?> active <?php endif; ?>">
        <a href="<?php echo e(route('admin.email-settings.index')); ?>"><?php echo app('translator')->get('app.menu.emailSettings'); ?></a></li>
    <li class="tab <?php if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.slack-settings.index'): ?> active <?php endif; ?>">
        <a href="<?php echo e(route('admin.slack-settings.index')); ?>"><?php echo app('translator')->get('app.menu.slackSettings'); ?></a></li>
    <li class="tab <?php if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.push-notification-settings.index'): ?> active <?php endif; ?>">
        <a href="<?php echo e(route('admin.push-notification-settings.index')); ?>"><?php echo app('translator')->get('app.menu.pushNotifications'); ?></a></li>
</ul>
...
<?php $__env->stopSection(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/sections/notification_settings_menu.blade.php ENDPATH**/ ?>