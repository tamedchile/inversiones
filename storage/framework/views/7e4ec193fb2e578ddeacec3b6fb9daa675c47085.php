    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading"><?php echo app('translator')->get('app.menu.customFields'); ?></div>
                    ...
                    <div class="tab-content">
                        <div id="vhome3" class="tab-pane active">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <button id="add-field" class="btn btn-success btn-outline"><i class="fa fa-plus"></i> <?php echo app('translator')->get('modules.customFields.addField'); ?>
                                            </button>
                                        </div>
                                    </div>
...
<script src="<?php echo e(asset('plugins/bower_components/jquery.repeater/jquery.repeater.js')); ?>"></script>
<script>
    $(function() {
        var table = $('#custom_fields').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('admin.custom-fields.data'); ?>',
            "order": [[ 0, "desc" ]],
            deferRender: true,
            language: {
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "<?php echo e(route('admin.custom-fields.destroy',':id')); ?>";
...
//                                    swal("Deleted!", response.message, "success");
        ...
        $('#add-field').click(function(){
            var url = '<?php echo e(route('admin.custom-fields.create')); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/custom-fields/index.blade.php ENDPATH**/ ?>