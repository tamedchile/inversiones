    ...
    <li id="dp_<?php echo e($userList->id); ?>">
        <a href="javascript:void(0)" id="dpa_<?php echo e($userList->id); ?>"
           ...
           onclick="getChatData('<?php echo e($userList->id); ?>', '<?php echo e($userList->name); ?>')">
            ...
            <img src="<?php echo e($userList->image_url); ?>" alt="user-img" class="img-circle">
...
<?php endif; ?>
<?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/client/user-chat/ajax-user-list.blade.php ENDPATH**/ ?>