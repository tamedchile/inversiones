<div class="modal-header">
    ...
    <h4 class="modal-title"><?php echo app('translator')->get('modules.tasks.taskCategory'); ?></h4>
</div>
    ...
    <div class="portlet-body">
        <div class="table-responsive">
            <table class="table">
                ...
                <tr>
                    <th>#</th>
                    <th><?php echo app('translator')->get('modules.taskCategory.categoryName'); ?></th>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="3"><?php echo app('translator')->get('messages.noTaskCategory'); ?></td>
                    </tr>
                <?php endif; ?>
                </tbody>
            </table>
            ...
            <div class="row">
                <div class="col-xs-12 ">
                    <div class="form-group">
                        <label><?php echo app('translator')->get('modules.taskCategory.categoryName'); ?></label>
...
</script><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/admin/tasks/create-category.blade.php ENDPATH**/ ?>