    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            <a href="javascript:;" id="new-chat" class="btn btn-success btn-outline btn-sm"><i
                class="icon-note"></i> <?php echo app('translator')->get("modules.messages.startConversation"); ?></a>
...
<script>
    ...
    $('#submitBtn').on('click', function (e) {
        ...
        if (submitText == "" || submitText == undefined || submitText == null) {
            ...
            var url = "<?php echo e(route('member.user-chat.message-submit')); ?>";
    ...
    $("#userSearch").keyup(function (e) {
        var url = "<?php echo e(route('member.user-chat.user-search')); ?>";
    ...
    function getChatData(id, dpName, scroll) {
        ...
        var url = "<?php echo e(route('member.user-chat.index')); ?>";
    ...
    $('#new-chat').click(function () {
        var url = '<?php echo e(route('member.user-chat.create')); ?>';
...
<?php echo $__env->make('layouts.member-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/inversiones.tamed.global/public_html/dashboard/resources/views/member/user-chat/index.blade.php ENDPATH**/ ?>